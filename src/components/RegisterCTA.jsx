    ...
    <section id="register" className="register">
      <div className="container register__inner">
        ...
        <div className="register__contact">
          <a href="tel:0123456789" className="register__phone">
            <svg
          ...
          <div className="register__socials">
            {registerCta.contactLinks.map((label) => {
              const social = SOCIAL_LINKS[label]
              return (
                <a
                  key={label}
                  href={social.href}
                ...
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill={social.outline ? 'none' : 'currentColor'}
                    stroke={social.outline ? 'currentColor' : 'none'}
                    strokeWidth={social.outline ? 1.6 : 0}
                  >
                    {social.render()}
                  </svg>
                  <span>{label}</span>
